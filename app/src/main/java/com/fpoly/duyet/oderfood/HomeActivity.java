...
import com.fpoly.duyet.oderfood.Adapter.CategoryAdapter;
...
import com.fpoly.duyet.oderfood.Database.Local.CartDataSource;

import com.fpoly.duyet.oderfood.Database.Local.DTDRoomDatabase;
import com.fpoly.duyet.oderfood.Database.Local.FavoriteDataSource;
...
import com.fpoly.duyet.oderfood.Utils.ProgressRequestBody;
import com.fpoly.duyet.oderfood.Utils.UploadCallBack;
...
//        }
    ...
    private void initDB() {
        Common.dtdroomdatabse= DTDRoomDatabase.getInstance(this);
        Common.cartRepository= CartRepository.getInstance(CartDataSource.getInstance(Common.dtdroomdatabse.cartDAO()));
        Common.favoriteRepository= FavoriteRepository.getInstance(FavoriteDataSource.getInstance(Common.dtdroomdatabse.favoriteDAO()));
    }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Toast.makeText(this, "Press the button again to exit", Toast.LENGTH_SHORT).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_sign_out) {
            ...
            builder.setMessage("Do you want to esit this application");
